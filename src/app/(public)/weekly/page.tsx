...
export const metadata: Metadata = { title: "AI 周报" };
...
export default async function WeeklyPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">AI 周报</h1>
      <div className="space-y-8">
        ...
        {digests.length === 0 && (
          <p className="text-gray-500 text-center py-12">暂无周报，系统将每周日 08:00 自动生成。</p>
        )}
      </div>
    </div>
  );
